...
if (!article) {
  ...
  contenu.innerHTML = `<p class="back-link"><a href="index.html">← Retour aux articles</a></p>
    <h1>${article.titre}</h1><p class="article-meta">Publié le ${article.date} par ${article.auteur}</p>
